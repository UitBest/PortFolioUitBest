<template>
    <v-card
        ...
        rounded="lg"
        :subtitle="showEmail ? 'info@uit.best' : 'Web Development'"
        :title="showEmail ? 'E-mail samenstellen' :  'Uit Best'"
...
<script setup>
    ...
    const send = () => {
        ...
        const href = `mailto:info@uit.best?subject=${encodeURIComponent(subject.value)}&body=Beste,%0D%0A%0D%0A${encodeURIComponent(body.value)}%0D%0A%0D%0AMet Vriendelijke groet,%0D%0A${encodeURIComponent(name.value)}`;
